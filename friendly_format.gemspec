...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-12-31}
  s.default_executable = %q{friendly_format}
 ...
 you can partially allow some tags and don't escape them.}
  ...
  s.executables = ["friendly_format"]
  s.extra_rdoc_files = ["CHANGES", "LICENSE", "NOTICE", "README", "Rakefile", "TODO", "bin/friendly_format", "friendly_format.gemspec", "test/sample/complex_article.txt", "test/sample/complex_article_result.txt"]
  s.files = ["CHANGES", "LICENSE", "NOTICE", "README", "Rakefile", "TODO", "bin/friendly_format", "friendly_format.gemspec", "lib/friendly_format.rb", "lib/friendly_format/adapter/hpricot_adapter.rb", "lib/friendly_format/adapter/nokogiri_adapter.rb", "lib/friendly_format/set_common.rb", "lib/friendly_format/set_strict.rb", "lib/friendly_format/version.rb", "test/sample/complex_article.txt", "test/sample/complex_article_result.txt", "test/test_friendly_format.rb"]
